 ...
 * 226 Playwright tests over 38 spec files, 365 passing Python tests, and Go
...
export const NOT_COVERED_BY_THIS_GATE = [
  {
    job: 'e2e',
    what: '226 Playwright tests — the only ones hitting real Postgres + Redis',
