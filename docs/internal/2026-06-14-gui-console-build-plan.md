...
- G6b Grid selection for bulk actions · `4a966925` · the bulk bar (folder/tag/export) was reachable
  ...
  gui-jsdom 581 + ProfilesView parity 18 green · VISIBLE after rebuild #10.
- G6a Bulk profile export · `9aecaf91` · wired `profiles.export` (zero GUI callers, backlog Tier-2)
