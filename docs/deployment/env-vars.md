...
| `AUTH_MAGIC_LINK_URL`     | optional                 | per-env  | `https://app.driftstack.dev/auth/magic-link` | Override for the magic-link URL. Same shape as `AUTH_VERIFY_EMAIL_URL`. Dev default: `http://localhost:5173/auth/magic-link`. (No dashboard page exists yet — set this only when the dashboard adds the route.)                                                                                                                                                                                                                                                                                                                                                                                                            |
