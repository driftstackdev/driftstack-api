...
| Pricing model      | "What happens when I hit my concurrent cap?"                | "fail with HTTP 429 + a structured RFC 9457 problem-detail"                                                                                    | **Leave dense** — answer is for the developer audience; HTTP status + RFC names are signal of correctness, not bug                                                                                  |
