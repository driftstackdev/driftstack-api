...
export const API_TIERS: ApiTier[] = [
  // Free — perpetual entry tier (replaced the one-time trial_pack 2026-05-27).
  {
    ...
    concurrent: 1,
    archetypeAccess: 'iPhone 13 and iPhone 13 mini',
    support: 'Community',
  ...
  // Manual ladder — humans clicking GUI client, persistent profiles.
  {
    ...
    overagePerHourUsd: null,
    concurrent: 1,
    archetypeAccess: 'All current device types',
  ...
  },
  {
    ...
    overagePerHourUsd: null,
    concurrent: 'Custom',
    archetypeAccess: 'All current + custom device types',
    support:
...
export const SELF_HOSTED_SOURCE_ACCESS: Record<string, string> = {
  self_hosted_solo: 'Ready-to-run software',
  self_hosted_pro: 'Ready-to-run software',
