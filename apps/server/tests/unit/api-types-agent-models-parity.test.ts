...
describe('agent-models registry parity', () => {
  it('AgentModelSchema = the 3 Claude 4.x picker models', () => {
  ...
  it('DEFAULT_AGENT_MODEL is Opus 4.7 (highest-capability default)', () => {
    expect(DEFAULT_AGENT_MODEL).toBe('claude-opus-4-7');
  });
