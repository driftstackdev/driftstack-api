...
describe('W214.C sdk-typescript doc parity', () => {
  ...
  it('session-create body uses archetype/purpose, not target_url/profile_archetype (since 29-358 LOCKED_ARCHETYPE_ID — example uses the launch-default iphone17_ios18_7_safari26_4)', () => {
