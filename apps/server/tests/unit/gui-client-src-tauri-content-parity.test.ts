...
describe('W617 apps/gui-client/src-tauri/ content parity', () => {
  ...
  it('Cargo.toml: driftstack-gui crate 0.1.3 MIT non-publish + lib triplet (staticlib/cdylib/rlib) + Tauri 2.0 + plugins + zeroize process-memory control keys + V-241 keyring + custom-protocol pinned', () => {
