...
describe('OsReadout', () => {
  ...
  it('shows the observed os + confidence (no coercion of the confidence label) — and an Apple reading is the match, in green (owner item 9, 2026-09-24: "if it\'s a Apple, it should be green status")', () => {
    render(
