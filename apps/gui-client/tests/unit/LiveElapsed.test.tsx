// Worktimer (backlog #3) — LiveElapsed component + formatStopwatch pins.

import { describe, expect, it } from 'vitest';
import { render, screen } from '@testing-library/react';
import { formatStopwatch, LiveElapsed } from '../../src/components/LiveElapsed';
...
describe('formatStopwatch', () => {
  it('renders M:SS under an hour with zero-padded seconds', () => {
    ...
    expect(formatStopwatch(12 * 60_000 + 34_000)).toBe('12:34');
  ...
  it('renders H:MM:SS at/over an hour with zero-padded minutes + seconds', () => {
    ...
    expect(formatStopwatch(25 * 3_600_000 + 5 * 60_000 + 9_000)).toBe('25:05:09');
  });
