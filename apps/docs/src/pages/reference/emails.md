...
| **Someone is trying to sign in to your Driftstack account**   | Someone entered the account's password correctly and then the wrong two-factor code 10 times in 15 minutes, so two-factor sign-in is paused for 15 minutes. Sent once per pause. If it wasn't you, reset your password.                               |
