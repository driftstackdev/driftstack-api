...
- The complete sub-processor list, with each provider's region and
  ...
  [driftstack.io/trust/sub-processors](https://driftstack.io/trust/sub-processors/)
  and in the [DPA](https://driftstack.io/legal/dpa/).
...
the [DPA](https://driftstack.io/legal/dpa/) (the retention table
...
- [Sub-processor register](https://driftstack.io/trust/sub-processors/) — every provider, region, purpose, and transfer basis, with a change log
- [DPA](https://driftstack.io/legal/dpa/) — the binding data-processing terms
- [Privacy policy](https://driftstack.io/legal/privacy/)
- [Trust & security overview](https://driftstack.io/trust/security-overview/)
