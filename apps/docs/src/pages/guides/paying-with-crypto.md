...
([refund policy](https://driftstack.io/legal/refunds/)), so this page
...
1. Open **Select tier** in the [dashboard](https://app.driftstack.io)
   and pick a tier.
...
([policy](https://driftstack.io/legal/refunds/)). If you expect to
