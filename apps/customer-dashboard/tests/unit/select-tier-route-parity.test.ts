// W331.C — drift guard for /select-tier page. The page lets new
// users either claim the trial pack or jump straight to Stripe
// checkout for a paid tier:
//   POST /v1/billing/trial-pack
//   POST /v1/billing/checkout-session
// Both must be registered server-side.
...
describe('W331.C /select-tier ↔ billing route parity', () => {
  ...
  it('server registers /v1/billing/trial-pack', () => {
